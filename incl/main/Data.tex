...
\input{code/Data/Dataframes/parFixed_NoBSV_CP_10_Init_1}

\input{code/Data/Dataframes/parFixed_NoBSV_DV_10_Init_1}
...
\input{code/Data/Dataframes/parFixed_NoBSV_CP_25_Init_1}
\begin{itemize}
    \item DV10 vs. DV25: Higher sd for 25sp
\end{itemize}

\input{code/Data/Dataframes/parFixed_NoBSV_DV_25_Init_1}


\subsection{50 sample profile}
\input{code/Data/Dataframes/parFixed_NoBSV_CP_50_Init_1}

\input{code/Data/Dataframes/parFixed_NoBSV_DV_50_Init_1}


\subsection{100 sample profile}
\input{code/Data/Dataframes/parFixed_NoBSV_CP_100_Init_1}

\input{code/Data/Dataframes/parFixed_NoBSV_DV_100_Init_1}

\section{Model with ETAs on CL and Q}
\subsection{10 sample profile}
\input{code/Data/Dataframes/parFixed_ETA_CLQ_CP_10_Init_1}
\input{code/Data/Dataframes/parFixed_ETA_CLQ_DV_10_Init_1}
\subsection{25 sample profile}
\input{code/Data/Dataframes/parFixed_ETA_CLQ_CP_25_Init_1}
\input{code/Data/Dataframes/parFixed_ETA_CLQ_DV_25_Init_1}
\subsection{50 sample profile}
\input{code/Data/Dataframes/parFixed_ETA_CLQ_CP_50_Init_1}
\input{code/Data/Dataframes/parFixed_ETA_CLQ_DV_50_Init_1}
\subsection{100 sample profile}
\input{code/Data/Dataframes/parFixed_ETA_CLQ_CP_100_Init_1}
\input{code/Data/Dataframes/parFixed_ETA_CLQ_DV_100_Init_1}

\section{Model with ETAs on V2 and V3}
\subsection{10 sample profile}
\input{code/Data/Dataframes/parFixed_ETA_V_CP_10_Init_1}
\input{code/Data/Dataframes/parFixed_ETA_V_DV_10_Init_1}
\subsection{25 sample profile}
\input{code/Data/Dataframes/parFixed_ETA_V_CP_25_Init_1}
\input{code/Data/Dataframes/parFixed_ETA_V_DV_25_Init_1}
\subsection{50 sample profile}
\input{code/Data/Dataframes/parFixed_ETA_V_CP_50_Init_1}
\input{code/Data/Dataframes/parFixed_ETA_V_DV_50_Init_1}
\subsection{100 sample profile}
\input{code/Data/Dataframes/parFixed_ETA_V_CP_100_Init_1}
